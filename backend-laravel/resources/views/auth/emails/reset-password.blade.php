...
<body>
    ...
    <div class="btn-content" style=" text-align: center;margin:2rem;">
        <a href="{{route('password.reset',['email' => $user->email, 'token' => $user->token])}}" class="btn" style="text-align: center;margin:2rem auto;text-decoration:none;color:#7241F3;font-weight:600;border:1px solid #7241F3;padding:.5rem 1rem;border-radius:2rem;transition:.3s;text-transform:capitalize" onmouseover="this.style.backgroundColor='#619d09';this.style.color='white'" onmouseout="this.style.backgroundColor='#white';this.style.color='#619d09'">
